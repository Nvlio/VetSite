...
export default function PageBlog() {
    ...
    const OffNews = [{
        title: "Notícia Importante",  // Título da notícia
        article: "Este é o conteúdo da notícia, onde explicamos os detalhes sobre o evento.", // Artigo explicativo
        file: "documento.pdf",  // Arquivo relacionado à notícia
        imagem: "jpg",  // Extensão da imagem (extraída com .split(".")[1])
        id: 12345  // ID único da notícia
    }];
